...
class ConfigSimulationVisualizer: #TODO AD
    simulation_size: int
    window_size: int
    FPS: int = 30
...
class SimulationVisualizer: #TODO AD
    ...
    def __init__(
        ...
        self.config: ConfigSimulationVisualizer = config_simulation_visualizer
        ...
        self.terrain_matrix = self.resource_manager.create_terrain()
    ...
    def _update_terrain_matrix(
            self,
            terrain_matrix: NDArray
    ) -> None:
        # 1. Resets the matrix to ID 0 (Water).
        self.terrain_matrix.fill(0)

        # 2. Assigns IDs based on the received terrain matrix.
    ...
    def simulation_loop(self) -> bool: #TODO AD
        ...
        agents_df: DataFrame = self.agent_manager.get_agent_dataframe()
